...
#    Sep 26, 2018 08:27:03 PM CEST  platform: Linux
...
class Git_Review:
    def __init__(self, top=None):
        ...
        self.edName.place(relx=0.184, rely=0.023,height=21, relwidth=0.794)
        ...
        self.edName.configure(width=474)

        self.Label1 = Label(top)
        self.Label1.place(relx=0.017, rely=0.023, height=21, width=91)
        ...
        self.edRepository.place(relx=0.184, rely=0.09, height=21, relwidth=0.794)

        self.edRepository.configure(background="white")
        self.edRepository.configure(selectbackground="#c4c4c4")
        self.edRepository.configure(textvariable=mainwin_ui_support.edRepository)
        self.edRepository.configure(width=474)

        self.Label4 = Label(top)
        self.Label4.place(relx=0.017, rely=0.09, height=21, width=91)
        ...
        self.comboBaseBranch.configure(width=167)
        ...
        self.comboToBranch.configure(width=167)
        ...
        self.TButton1.configure(width=62)
        ...
        self.TLabel1.configure(width=92)
